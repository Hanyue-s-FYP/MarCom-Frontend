...
<template>
  <div class="border border-neutral-400 p-2 rounded-[15px] flex flex-col gap-2">
    <p>{{ envName }}</p>
    <p class="text-neutral-400 text-xs font-medium line-clamp-3 overflow-ellipsis flex-grow">
      {{ envDesc }}
    </p>
